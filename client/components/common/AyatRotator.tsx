...
export function AyatRotator() {
  ...
  if (reducedMotion) {
    return (
      <div
        aria-hidden="true"
        className="pointer-events-none absolute inset-x-0 top-0 z-[2] hidden items-center justify-center border-b border-white/5 bg-black/20 px-6 py-2 backdrop-blur-sm sm:flex"
      >
        {content}
      </div>
    );
